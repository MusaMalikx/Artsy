      ...
      <section class="h-screen">
        ...
        <div class="px-6 pb-12 ">
          <div class="flex justify-center lg:pt-24 flex-wrap h-full g-6 text-gray-800">
            <div class="md:w-7/12 lg:w-5/12 mb-12 md:mb-0 h-96 items-center overflow-hidden relative">
            ...
            <div class="md:w-8/12 lg:w-5/12 lg:ml-20">
              <form>
                ...
                <div className='mt-6 text-center'>
                  <p onClick={()=>navigate('/signup')} >Need an Account? <span className='text-primary hover:text-primary focus:text-primary hover:underline hover:underline-offset-2 cursor-pointer'>Sign Up</span></p>
                </div>
