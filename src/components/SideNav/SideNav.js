          ...
          <Sidenav.Body className="">
            <Nav activeKey={activeKey} onSelect={setActiveKey}>
              ...
              <Nav.Menu
                ...
                <Nav.Item onClick={() => navigate('/view/buyer/proposal')} eventKey="4-1">
                  Proposals
                </Nav.Item>

                <Nav.Item onClick={() => navigate('/add/artwork')} eventKey="4-2">
                  Add Artwork
                </Nav.Item>
                <Nav.Item onClick={() => navigate('/artist/dashboard')} eventKey="4-3">
                  Artist Dashboard
                </Nav.Item>
                <Nav.Item onClick={() => navigate('/artist/auctions')} eventKey="4-4">
                  Artist View Auctions List
                </Nav.Item>
              </Nav.Menu>

              <Nav.Menu placement="rightStart" eventKey="5" title="Advanced" icon={<MagicIcon />}>
