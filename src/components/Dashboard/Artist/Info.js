      ...
      <div class="px-6 pt-6 2xl:container">
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div class="md:col-span-2 lg:col-span-1">
            <div class="h-full py-8 px-6 space-y-6 rounded-xl shadow-lg bg-white">
              <svg
          ...
          <div>
            <div class="h-full py-6 px-6 rounded-xl shadow-lg bg-white">
          ...
          <div>
            <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl shadow-lg bg-white">
              <svg
                class="w-40 m-auto"
                viewBox="0 0 56 56"
                fill="none"
