...
import { Button, IconButton, List, Modal, Panel, Popover, Whisper } from 'rsuite';
      ...
      <main className="px-4">
        ...
        <div className="">
          <div className="my-3">
            <input
              type="text"
              className="block w-full px-5 py-3 border rounded-lg bg-white shadow-lg placeholder-gray-400 text-gray-700 focus:ring focus:outline-none"
